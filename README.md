...
## 📱 Exemplo de Integração com o App Flutter (Dart)

No aplicativo Flutter (`lib/`), adicione um serviço de sincronização remota:

```dart
import 'dart:convert';
import 'package:http/http.dart' as http;
import '../domain/models/pest_record.dart';

class RemoteSyncService {
  final String baseUrl = 'http://seu-servidor:3000/api/v1';
  String? _authToken;
  ...
  /// Sincroniza os registros locais do SQLite com o servidor
  Future<bool> syncOfflineRecords(List<PestRecord> localRecords) async {
    final payload = {
    ...
    final response = await http.post(
      Uri.parse('$baseUrl/pest-records/sync'),
      headers: {
